...
function Jet(; system, M, Ms, Δ, Δ′, Δ′′, Δ′′′, Δ⁴, Δ⁵, D1, D01, D11, D11v1, D2, D2v1, D02, D3, D21, D12, D03, D4, D31, D5, D6, D7, D41, D51, D22, D32, D13, D23, D33)
    Jet(system, M, Ms, Δ, Δ′, Δ′′, Δ′′′, Δ⁴, Δ⁵, D1, D01, D11, D11v1, D2, D2v1, D02, D3, D21, D12, D03, D4, D31, D5, D6, D7, D41, D51, D22, D32, D13, D23, D33)
end

function Base.show(io::IO, ::MIME"text/plain", jet::PeriodicNormalizationDDEs.Jet)
    # Start by printing a header or summary
    println(io, "Jet Object Summary:")
    
    # Display important fields with appropriate formatting
    println(io, "Jacobian: ", jet.D1)
end
